  ...
  R6::R6Class(
    ...
    public = list(
      ...
      insert_disk = function(disk, write_protected = TRUE) {
        ...
        insert_disk_into_(private$pointer, disk$get_pointer(),
                          write_protected, private$index)
        self
      },
      ...
      eject_disk = function(delay = 0) {
        eject_disk_(private$pointer, private$index, as.integer(delay))
        self
      },
      ...
      get_info = function() {
        fdrive_info_(private$pointer, private$index)
      },
